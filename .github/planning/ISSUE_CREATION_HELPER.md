# GitHub Issues Creation Helper

This file provides ready-to-copy content for creating GitHub Issues from the ROADMAP_v1.1.0.md file.

## How to Use

1. Go to https://github.com/VaultBricks/DSS/issues/new
2. Select "Feature Request" template
3. Copy the content from the relevant issue below
...
**Title:**
```
[FEATURE] Add Foundry Support & Examples
```
...
**Body (copy this into the Feature Request template):**
...
- See `.github/planning/ROADMAP_v1.1.0.md` for full details
```
...
**Title:**
```
[FEATURE] Develop DSS CLI Tool for Automated Certification Report Generation
```
...
**Title:**
```
[FEATURE] Add Concrete Operational Security Examples for DSS-9
```
...
**Title:**
```
[FEATURE] Create Public Registry of DSS-Certified Strategies
```
...
**Title:**
```
[FEATURE] Create Auditor-Focused Checklists and Templates
```
...
## Batch Creation Script (Alternative)

If you have GitHub CLI installed, you can use this script to create all issues at once:
...
gh issue create \
  ...
  --body-file .github/planning/ROADMAP_v1.1.0.md \
  --label "type: feature,component: examples,priority: high,status: help wanted" \
  --milestone "v1.1.0"
```

For now, manual creation via the GitHub web interface is recommended using the content above.
